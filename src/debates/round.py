...
- Potential for Apathy""",
        ...
        self.model = ChatOpenAI(model_name="gpt-3.5-turbo", temperature=GlobalConfig.LLM_TEMPERATURE)  # mypy: ignore
    ...
    def gov_opening(self):
        gov_prompt_template = ChatPromptTemplate.from_messages(
            [
                (
                    "system",
                    "In parliament debates, you are the government. You are arguing for the motion: {gov_motion}. Your reasons are:\n{gov_args}\n\n{gov_mod}",
                ),
            ]
